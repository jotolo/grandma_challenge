...
RSpec.describe RecipesController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryBot.attributes_for(:recipe)
  }

  let(:invalid_attributes) {
    FactoryBot.attributes_for(:recipe, name: nil, recipe: nil)
  }
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      let(:new_attributes) {
        { name: 'Ropa Vieja', recipe: 'Cook the meet until is delicious' }
      }
      ...
      it 'updates the requested recipe' do
        ...
        expect(recipe.recipe).to eq(new_attributes[:recipe])
      end
